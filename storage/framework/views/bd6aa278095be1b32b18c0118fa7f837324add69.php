                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group<?php echo e($errors->has('job') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="job" type="text" class="form-control" name="job" value="<?php echo e(old('job')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('income') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="income" type="text" class="form-control" name="income" value="<?php echo e(old('income')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('npwp') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="npwp" type="file"accept="image/*" class="form-control" name="npwp" value="<?php echo e(old('npwp')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('home_price') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="home_price" type="number" class="form-control" name="home_price" value="<?php echo e(old('home_price')); ?>" required>
